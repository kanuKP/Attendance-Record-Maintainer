...
*/
	try {
	    ...
	    conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:SJ", "C##", "1amthebest.");
	...
	// jLabel2.setVisible(false);
	    try{
	String sql = "select date1, student_idstudent from attendence where student_subject_subjectid = ? and status=?";
	pst  = (OraclePreparedStatement) conn.prepareStatement(sql);
	pst.setString(1,a);
